...
class DishRepository:
    ...
    async def _check_exists_dish_by_attr(self, dish_create: DishCreate, submenu_id: UUID, attr: str) -> None:
    ...
    async def create_dish(self, submenu_id: UUID, dish_create: DishCreate) -> Dish:
        await self._check_exists_dish_by_attr(submenu_id=submenu_id, dish_create=dish_create, attr='title')
