...
class MenuRepository:
    ...
    async def _check_exists_menu_by_attr(self, menu_create: MenuCreate, attr: str) -> None:
    ...
    async def get_all(self) -> list[MenuResponse]:
        ...
        list_menus = [MenuResponse.model_validate(row, from_attributes=True) for row in result]
        return list_menus
